...
def create_datastax_connection():
    ...
    cloud_config= {'secure_connect_bundle': 'Bundel.zip'}

    with open("lolooo8900@gmail.com-token.json") as f:
        secrets = json.load(f)
...
def main():
    ...
    os.environ['GRADIENT_ACCESS_TOKEN'] = "bC5YjDZCy8SBJKhQ0pJHkwgJaaOXpfP0"
    os.environ['GRADIENT_WORKSPACE_ID'] = "422414bf-ed19-4c47-81b6-a602f9e5a168_workspace"
